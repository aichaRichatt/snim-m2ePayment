...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '54b4c616-51c7-4c5f-94e0-29accf2e9ed4' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('8003954b-a5ac-4784-8f9e-c91ef7769e61');
      cy.get(`[data-cy="name"]`).should('have.value', '8003954b-a5ac-4784-8f9e-c91ef7769e61');
